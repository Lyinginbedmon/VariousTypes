...
public abstract class Config
{
	...
	public void read()
	{
		...
		{
			VariousTypes.LOGGER.error("Generated new config file "+fileName);
			save();
			return;
		}
		catch(IOException e)
		{
			VariousTypes.LOGGER.error("Couldn't read config file "+fileName);
			e.printStackTrace();
		}
	...
	public void save()
	{
		try
		{
			...
			writer.close();
			if(!fileExists)
				VariousTypes.LOGGER.info("Generated new config file "+fileName);
		}
		catch(IOException e)
		{
			VariousTypes.LOGGER.error("Couldn't read config file "+fileName);
