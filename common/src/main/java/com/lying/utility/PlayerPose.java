...
public enum PlayerPose
{
	...
	CRAWLING(0, EntityPose.SWIMMING, p -> !p.isSwimming(), false),
	SWIMMING_IDLE(2, EntityPose.SWIMMING, false),
	SWIMMING_POWERED(1, EntityPose.SWIMMING, p -> p.hasStatusEffect(StatusEffects.DOLPHINS_GRACE), false),
